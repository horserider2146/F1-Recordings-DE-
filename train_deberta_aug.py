...
with open(os.path.join(BASE, 'models', 'scaler_deberta_aug.pkl'), 'wb') as f:
...
# -- 5. Model (last 2 DeBERTa encoder layers unfrozen) -------------------------
...
best_val_f1     = 0.0
patience_count  = 0
best_model_path = os.path.join(BASE, 'models', 'best_model_deberta_aug.pt')
history         = []
...
pd.DataFrame(history).to_csv(os.path.join(BASE, 'models', 'history_deberta_aug.csv'), index=False)
...
print('Done. History saved to models/history_deberta_aug.csv')
